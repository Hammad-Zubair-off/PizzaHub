...
import { FaBox, FaTruck, FaClock, FaMapMarkerAlt, FaTimes, FaFilter } from 'react-icons/fa';
...
const OrdersScreen = () => {
    ...
    const groupOrdersByStatus = (orders) => {
        ...
        return Object.entries(groups).sort(([statusA], [statusB]) => 
        ...
        <OrdersContainer>
            <ContentWrapper>
                <FilterContainer>
                    <PageTitleWrapper>
                        <FaBox />
                        <PageTitle>My <span>Orders</span></PageTitle>
                    </PageTitleWrapper>
                    <Dropdown>
                ...
                {orders.length === 0 ? (
                    ...
                    <NoOrders>
                        <h5>No {selectedStatus !== 'all' ? getStatusLabel(selectedStatus) : ''} orders found</h5>
                        <p>There are no orders with the selected status.</p>
                    </NoOrders>
                ) : (
                    groupOrdersByStatus(filterOrders(orders)).map(([status, statusOrders]) => (
                                        ...
                                        <OrderTable>
                                            ...
                                            <tbody>
                                                {order.items.map((item, index) => (
                                                    <tr key={index}>
                                                        <td>
                                                            <div style={{ fontWeight: '500', color: '#2d3436' }}>
