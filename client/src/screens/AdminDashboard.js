    ...
    return (
        <DashboardContainer>
            <div className="container">
                <DashboardHeader>
                    <PageTitle>Admin <span>Dashboard</span></PageTitle>
                </DashboardHeader>
                    ...
                    <Col lg={3} md={6} className="mb-4">
                        <StatCard>
                            <Card.Body>
                                ...
                                <div className="stat-value">Rs. {orders.reduce((acc, order) => acc + order.totalAmount, 0).toFixed(2)}</div>
                                <div className="stat-change">
                                    <i className="fas fa-arrow-up"></i>
                                    15% from last month
                                </div>
                                    ...
                                    <tbody>
                                        {pizzas.map(pizza => (
                                            <tr key={pizza._id}>
                                                ...
                                                <td>
                                                    <StyledBadge bg={pizza.isAvailable ? 'success' : 'danger'}>
                                ...
                                <tbody>
                                    {users.map(user => (
                                        <tr key={user._id}>
                                            ...
                                            <td>{user.email}</td>
                                            <td>
                                                <StyledBadge bg={user.role === 'admin' ? 'danger' : 'info'}>
                    ...
                    <Modal.Body>
                        <Form onSubmit={handleSubmit}>
                            ...
                            <FormSection>
                                ...
                                <div className="text-muted mt-3" style={{ 
                                    fontSize: '0.85rem',
